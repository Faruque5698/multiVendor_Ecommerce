                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td>{{$user->email}}</td>
                                        <td><img src="{{asset($user->photo)}}" alt="{{$user->name}}" width="100px" height="100px"></td>
                                        <td>{{$user->roll == 'admin' ? 'Admin':'Customer'}}</td>
                                        <td>
...
{{--                                            @endif--}}
                                            ...
                                            <a href="{{route('user_edit',['id'=>$user->id])}}" class="btn btn-sm btn-success"><i class="fa fa-edit"></i></a>
                                            <a href="{{route('user_details',['id'=>$user->id])}}" class="btn btn-sm btn-success"><i class="icon-zoom-in"></i></a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-danger">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <a href="{{route('user_ban',['id'=>$user->id])}}" class="btn btn-outline-light">Delete</a>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                        </div>
